...
activities = {
    ...
    "Drama Club": {
        "description": "Develop acting skills and perform scenes for the school community",
    ...
    "Science Club": {
        "description": "Conduct experiments and investigate questions about the natural world",
